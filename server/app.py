...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///app.db' #sets up existing database
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False #helps to avoid building up a lot of data in memory
